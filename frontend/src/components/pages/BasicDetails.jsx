    ...
    <div className="bg-[#f6f6f6] flex justify-center items-center">
      <div className="bg-[#fefefe] w-[90%] my-[10%] rounded-2xl shadow-2xl flex flex-wrap md:p-10 p-2">
        ...
        <div className="w-full md:w-1/2 p-5 flex flex-col justify-center">
          <h1 className="antialiased font-extrabold font text-3xl text-left mb-10">
            Enter Basic Details
          </h1>
          <form className="mt-5" onSubmit={(e) => handleSubmit(e)}>
            ...
            <input
              ...
              className={input_box}
              onChange={(e) =>
                setStudentDetails({ ...studentDetails, studentName: e.target.value })
              }
            />
            <input
              type="text"
              name="RFID"
              id="RFID"
              placeholder="Enter your RFID NUID"
              required
              title="RFID"
              className={input_box}
              onChange={(e) => setStudentDetails({ ...studentDetails, RFID: e.target.value })}
            />
            ...
            <input
              ...
              className={input_box}
              onChange={(e) =>
                setStudentDetails({ ...studentDetails, phoneNumber: e.target.value })
              }
            />
            <input
              type="email"
            ...
            <button className="inline-flex items-center px-4 justify-center py-2 mt-5 font-bold leading-6 text-sm shadow rounded-md text-white bg-cyan-500 min-w-[7em] transition ease-in-out duration-150">
              <svg
                className={pState ? 'animate-spin -ml-1 mr-3 h-5 w-5 text-white' : 'hidden'}
